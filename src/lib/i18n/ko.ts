...
export const ko = {
  ...
  meta: {
    siteTitle: "새림 | 돼지 부산물·머릿고기·육가공 OEM",
    titleTemplate: "%s | 유한회사 새림",
    /** 제품 상세 <title>에 붙는 검색어 접미사 (영어만 사용) */
    productTitleSuffix: "",
    keywords: ["돼지 부산물", "돈두", "머릿고기", "내장", "막창", "뒷고기", "국밥 재료", "육가공 OEM", "HACCP", "군산 식품회사", "새림"],
    description:
      "유한회사 새림 공식 홈페이지. 군산·김제·용인 생산 거점에서 돼지 부산물, 머릿고기, 내장, 뒷고기를 가공하고 국밥 재료 도매 공급과 육가공 OEM·PB 생산을 제공합니다.",
    ogTitle: "새림 | 돼지 부산물·머릿고기·육가공 OEM",
    ogDescription: "유한회사 새림 공식 홈페이지. 돼지 부산물·머릿고기·뒷고기 가공, 국밥 재료 도매 공급, 육가공 OEM·PB 생산을 안내합니다.",
    pages: {
      why: { title: "회사 소개와 생산 철학", description: "새림은 제품을 판매하는 회사가 아니라, 대한민국 외식 산업을 준비하는 식품 인프라입니다." },
      brand: { title: "새림 브랜드 소개", description: "새림 · 전국국밥거래소 · 육식노트. 브랜드 아키텍처를 소개합니다." },
      business: { title: "식자재 도매 공급·육가공 사업", description: "도매 공급 · 채널 브랜드 운영 · OEM 생산 · HMR 개발. 새림의 B2B 사업 구조." },
      products: { title: "머릿고기·돼지 내장·뒷고기 제품", description: "삶은 머릿고기, 소창, 염통, 막창 등 돼지 부산물과 뒷고기 제품을 확인하세요. 국밥집·외식업체용 제품의 포장 규격, 생산 공정, 도매 납품을 안내합니다." },
      factory: { title: "군산·김제·용인 생산 공장", description: "군산 · 김제 · 용인. 새림의 세 공장은 각각 하나의 브랜드입니다." },
      quality: { title: "HACCP 인증·식품 품질 관리", description: "입고부터 출고까지, 새림의 8단계 품질 여정을 인터랙티브로 확인하세요." },
      oem: { title: "육가공 OEM·PB 위탁생산", description: "돼지 부산물 가공과 햄·육가공 OEM·PB 위탁생산. 김제·용인 생산 라인에서 레시피 구현, 시제품, 포장 규격 협의부터 생산·납품까지 상담합니다." },
      news: { title: "새림 소식", description: "게시판이 아니라 브랜드 스토리. 새림의 소식을 전합니다." },
      store: { title: "제품 소량 구매·공식 판매처", description: "새림의 제품을 소량으로 먼저 경험해 보세요. 스마트스토어·카카오 채널 안내." },
      contact: { title: "식자재 도매·OEM 납품 문의", description: "도매·OEM·일반 문의. 품목, 수량, 납기 조건을 알려주시면 맞춤 공급안을 제안합니다." },
      export: { title: "돼지 부산물·육가공품 수출 상담", description: "HACCP 인증 돼지 부산물·육가공·한식 밀키트 수출 안내. 검역 협정국 확인, 필요 서류, 인코텀즈·결제 조건." },
    },
  },
