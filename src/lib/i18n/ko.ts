...
export const ko = {
  ...
  meta: {
    ...
    description:
      "유한회사 새림 공식 홈페이지. 돼지 부산물·머릿고기·뒷고기 가공, 국밥 재료 도매 공급, 육가공 OEM·PB 생산을 안내합니다.",
    ...
    pages: {
      ...
      products: { title: "머릿고기·돼지 내장·뒷고기 제품", description: "삶은 머릿고기·소창·염통·막창 등 돼지 부산물과 뒷고기 제품. 국밥집·외식업체용 포장 규격, 생산 공정, 도매 납품을 안내합니다." },
      ...
      oem: { title: "육가공 OEM·PB 위탁생산", description: "돼지 부산물·햄·육가공 OEM·PB 위탁생산. 김제·용인 공장에서 레시피 구현, 시제품, 포장 규격부터 생산·납품까지 상담합니다." },
