...
const FACTORIES = [
  {
    ...
    description:
      "새림의 본사이자 심장입니다. 도축 직후의 돈두·내장류를 하루 1,500두(약 7톤) 규모로 세척·열처리·포장까지 원스톱 처리해 전국으로 직송합니다. 세절·원료보관·돈두가공·열가공·내포장·외포장·냉장·냉동 — 8개 전용 작업실을 분리 운영해 교차오염을 구조적으로 차단합니다.",
...
const QUALITY_STEPS = [
  ...
  },
  {
    ...
    metric: "FE 2.0mm 금속검출 전수 · 조도 1,000lux 이물검수",
  },
  {
    stepNo: 5,
    name: "미생물 관리",
...
const SETTINGS: Record<string, string> = {
  ...
  stat_daily: "1,500두",
  partners:
    "선진·하이포크, 농협 목우촌, 팜스코, 이마트, 이마트 트레이더스, 홈플러스, 쿠팡, 마켓컬리, 오아시스마켓, bhc, 하림산업, 군산 학교급식",
